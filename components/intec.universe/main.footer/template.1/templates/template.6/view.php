                            ...
                            <div class="widget-part-items">
                                ...
                                <?php if ($arResult['EMAIL']['SHOW']) { ?>
                                    <div class="widget-part-item widget-email">
                                        ...
                                        <a class="widget-part-item-text intec-cl-text" style= "color: #d6b1b3 !important;" href="mailto:<?= $arResult['EMAIL']['VALUE'] ?>">
                                ...
                                <?php if ($arResult['PHONE']['SHOW']) { ?>
                                    <div class="widget-part-item widget-phone">
                                        ...
                                        <a class="widget-part-item-text intec-cl-text" style= "color: #d6b1b3 !important;" href="tel:<?= $arResult['PHONE']['VALUE']['LINK'] ?>">
                                                ...
                                                <div class="widget-contacts-item">
                                                    ...
                                                    <?php if (!empty($arContact['PHONE'])) { ?>
                                                        <div class="widget-contacts-item-phone">
                                                            ...
                                                            <a href="tel:<?= $arContact['PHONE']['LINK'] ?>">
                                    ...
                                    <div class="widget-social-items">
                                        <?php foreach ($arResult['SOCIAL']['ITEMS'] as $arItem) { ?>
                                            ...
                                            <div class="widget-social-item">
                                                <a href="<?= $arItem['LINK'] ?>" class="widget-social-item-icon glyph-icon-<?= StringHelper::toLowerCase($arItem['CODE']) ?>"></a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
