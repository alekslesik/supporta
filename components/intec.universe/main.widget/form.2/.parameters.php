...
$arTemplateParameters['WEB_FORM_CONSENT_SHOW'] = [
    ...
    'TYPE' => 'LIST',
    'VALUES' => [
        'Y' => Loc::getMessage('C_WIDGET_FORM_2_WEB_FORM_CONSENT_SHOW_Y'),
        'N' => Loc::getMessage('C_WIDGET_FORM_2_WEB_FORM_CONSENT_SHOW_N'),
        'parameters' => Loc::getMessage('C_WIDGET_FORM_2_WEB_FORM_CONSENT_SHOW_PARAMETERS')
    ],
    'DEFAULT' => 'parameters'
];