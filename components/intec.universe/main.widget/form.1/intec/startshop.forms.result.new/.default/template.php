...
$arBlockBg = [
    ...
    'style' => [
        'background-image' => !empty($arViewParams['BLOCK_BACKGROUND']) ? 'url('.$arViewParams['BLOCK_BACKGROUND'].')' : null
    ]
];
$arFormBg = [
...
if ($arViewParams['FORM_ADDITIONAL_PICTURE_SHOW']) {
    $arAdditionalPicture = [
        ...
        'style' => [
            'background-image ' => 'url(' . $arViewParams['FORM_ADDITIONAL_PICTURE'] . ')',
                            ...
                            <?= Html::beginForm($sFormAction, 'post', $arForm) ?>
                                ...
                                <?php if ($arResult['USE_CAPTCHA'] == 'Y') { ?>
                                    <div class="form-result-new-captcha">
                                        <div class="form-result-new-captcha-title">
                                            <?= Loc::getMessage('C_FORM_RESULT_NEW_FORM1_CAPTCHA_TITLE') ?>
                                        </div>
