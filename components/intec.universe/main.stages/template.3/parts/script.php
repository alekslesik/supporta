...
<script type="text/javascript">
    (function () {
        ...
        container.setCollapsedHeight = function () {
            collapsedHeight = container.getElementHeight(0) + container.getElementHeight(1) + container.getElementHeight(2);
        };
        ...
        button.setText = function () {
            if (state === 'collapsed') {
                button.text('<?= Loc::getMessage('C_MAIN_STAGES_TEMPLATE_3_BUTTON_SHOW') ?>');
            } else if (state === 'expanded') {
                button.text('<?= Loc::getMessage('C_MAIN_STAGES_TEMPLATE_3_BUTTON_HIDE') ?>');
            }
        };
