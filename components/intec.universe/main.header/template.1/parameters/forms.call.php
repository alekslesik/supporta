...
$arTemplateParameters['FORMS_CALL_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALL_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['FORMS_CALL_SHOW'] == 'Y') {
    $arTemplateParameters['FORMS_CALL_ID'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALL_ID'),
        'TYPE' => 'LIST',
        'VALUES' => $arForms,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['FORMS_CALL_TEMPLATE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALL_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTemplates,
        'DEFAULT' => '.default',
        'ADDITIONAL_VALUES' => 'Y'
    ...
    $arTemplateParameters['FORMS_CALL_TITLE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALL_TITLE'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALL_TITLE_DEFAULT')
    ];
