...
$arReturn['SOCIAL_SHOW'] = [
    'PARENT' => 'VISUAL',
    'TYPE' => 'CHECKBOX',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP1_SOCIAL_SHOW'),
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['SOCIAL_SHOW'] == 'Y') {
    ...
    $arReturn['SOCIAL_VK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP1_SOCIAL_VK')
    ];

    $arReturn['SOCIAL_INSTAGRAM'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP1_SOCIAL_INSTAGRAM')
    ];

    $arReturn['SOCIAL_FACEBOOK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP1_SOCIAL_FACEBOOK')
    ];

    $arReturn['SOCIAL_TWITTER'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP1_SOCIAL_TWITTER')
    ];
}
