...
<div class="sale-basket-small-content">
    <div class="sale-basket-small-switches" data-role="switches">
        ...
        <?php if ($arResult['PERSONAL']['SHOW']) { ?>
            <a href="<?= $arResult['URL']['PERSONAL'] ?>" class="sale-basket-small-switch intec-cl-background-dark">
                <div class="sale-basket-small-switch-icon">
                    <div class="intec-aligner"></div>
        ...
        <?php if ($arResult['COMPARE']['SHOW']) { ?>
            <a href="<?= $arResult['URL']['COMPARE'] ?>" class="sale-basket-small-switch intec-cl-background-dark">
                <div class="sale-basket-small-switch-icon">
                    <div class="intec-aligner"></div>
