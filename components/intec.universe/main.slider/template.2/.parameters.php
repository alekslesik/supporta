...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    $arTemplateParameters['BLOCKS_USE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['BLOCKS_USE'] === 'Y') {
        $arTemplateParameters['BLOCKS_IBLOCK_TYPE'] = [
            'PARENT' => 'BASE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_IBLOCK_TYPE'),
            'TYPE' => 'LIST',
        ...
        $arTemplateParameters['BLOCKS_IBLOCK_ID'] = [
            'PARENT' => 'BASE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_IBLOCK_ID'),
            'TYPE' => 'LIST',
            'VALUES' => $arIBlocks,
            'ADDITIONAL_VALUES' => 'Y',
            'REFRESH' => 'Y'
        ...
        if (!empty($arCurrentValues['BLOCKS_IBLOCK_ID'])) {
            $arTemplateParameters['BLOCKS_MODE'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_MODE'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'N',
                'REFRESH' => 'Y'
            ];
            $arTemplateParameters['BLOCKS_SECTIONS'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_SECTIONS'),
                'TYPE' => 'LIST',
            ...
            $arTemplateParameters['BLOCKS_ELEMENTS_COUNT'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_ELEMENTS_COUNT'),
                'TYPE' => 'LIST',
                'VALUES' => [
                    1 => '1',
                    2 => '2',
    ...
    $arTemplateParameters['PROPERTY_HEADER_OVER'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_HEADER_OVER'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['PROPERTY_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_LINK'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyText,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    if (!empty($arCurrentValues['PROPERTY_LINK'])) {
        $arTemplateParameters['PROPERTY_LINK_BLANK'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_LINK_BLANK'),
            'TYPE' => 'LIST',
        ...
        $arTemplateParameters['PROPERTY_BUTTON_SHOW'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_BUTTON_SHOW'),
            'TYPE' => 'LIST',
            'VALUES' => $arPropertyCheckbox,
            'ADDITIONAL_VALUES' => 'Y',
            'REFRESH' => 'Y'
        ...
        if (!empty($arCurrentValues['PROPERTY_BUTTON_SHOW'])) {
            $arTemplateParameters['PROPERTY_BUTTON_TEXT'] = [
                'PARENT' => 'DATA_SOURCE',
                'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_BUTTON_TEXT'),
                'TYPE' => 'LIST',
                'VALUES' => $arPropertyText,
                'ADDITIONAL_VALUES' => 'Y'
            ];
    ...
    $arTemplateParameters['PROPERTY_TEXT_ALIGN'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_TEXT_ALIGN'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['PROPERTY_FADE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_FADE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyCheckbox,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['PROPERTY_SCHEME'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_SCHEME'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyCheckbox,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['PROPERTY_VIDEO'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_VIDEO'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyText,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    $arTemplateParameters['PROPERTY_VIDEO_FILE_MP4'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_VIDEO_FILE_MP4'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['PROPERTY_VIDEO_FILE_WEBM'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_VIDEO_FILE_WEBM'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyFile,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    $arTemplateParameters['PROPERTY_VIDEO_FILE_OGV'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_VIDEO_FILE_OGV'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyFile,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    if ($arCurrentValues['BLOCKS_USE'] === 'Y' && !empty($arCurrentValues['BLOCKS_IBLOCK_ID'])) {
        $arTemplateParameters['BLOCKS_PROPERTY_LINK'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_PROPERTY_LINK'),
            'TYPE' => 'LIST',
        ...
        if (!empty($arCurrentValues['BLOCKS_PROPERTY_LINK'])) {
            $arTemplateParameters['BLOCKS_PROPERTY_LINK_BLANK'] = [
                'PARENT' => 'DATA_SOURCE',
                'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_PROPERTY_LINK_BLANK'),
                'TYPE' => 'LIST',
...
$arTemplateParameters['HEIGHT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_HEIGHT'),
    'TYPE' => 'LIST',
    'VALUES' => [
        500 => '500px',
        550 => '550px',
...
if (!empty($arCurrentValues['PROPERTY_HEADER'])) {
    $arTemplateParameters['HEADER_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_HEADER_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['HEADER_SHOW'] === 'Y') {
        $arTemplateParameters['HEADER_VIEW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_HEADER_VIEW'),
            'TYPE' => 'LIST',
            'VALUES' => [
                1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_1'),
                2 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_2'),
                3 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_3'),
                4 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_4'),
                5 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_5')
            ],
            'DEFAULT' => 1
        ];
    }
...
if (!empty($arCurrentValues['PROPERTY_DESCRIPTION'])) {
    $arTemplateParameters['DESCRIPTION_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_DESCRIPTION_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['DESCRIPTION_SHOW'] === 'Y') {
        $arTemplateParameters['DESCRIPTION_VIEW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_DESCRIPTION_VIEW'),
            'TYPE' => 'LIST',
            'VALUES' => [
                1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_1'),
                2 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_2'),
...
if (!empty($arCurrentValues['PROPERTY_HEADER_OVER'])) {
    $arTemplateParameters['HEADER_OVER_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_HEADER_OVER_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['HEADER_OVER_SHOW'] === 'Y') {
        $arTemplateParameters['HEADER_OVER_VIEW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_HEADER_OVER_VIEW'),
            'TYPE' => 'LIST',
            'VALUES' => [
                1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_1')
            ],
...
if (!empty($arCurrentValues['PROPERTY_BUTTON_SHOW'])) {
    $arTemplateParameters['BUTTON_VIEW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BUTTON_VIEW'),
        'TYPE' => 'LIST',
        'VALUES' => [
            1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_1'),
            2 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_2'),
...
if (
    ...
    $arTemplateParameters['VIDEO_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIDEO_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
...
if ($arCurrentValues['BLOCKS_USE'] === 'Y' && !empty($arCurrentValues['BLOCKS_IBLOCK_ID'])) {
    $arBlocksPosition = [
        'left' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_POSITION_LEFT'),
        'right' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_POSITION_RIGHT')
    ];

    if ($arCurrentValues['BLOCKS_ELEMENTS_COUNT'] > 1)
        $arBlocksPosition['both'] = Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_POSITION_BOTH');

    $arTemplateParameters['BLOCKS_POSITION'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_POSITION'),
        'TYPE' => 'LIST',
        'VALUES' => $arBlocksPosition,
        'DEFAULT' => 'right'
    ];

    unset($arBlocksPosition);

    $arTemplateParameters['BLOCKS_EFFECT_FADE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_EFFECT_FADE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
    $arTemplateParameters['BLOCKS_EFFECT_SCALE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_EFFECT_SCALE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
    $arTemplateParameters['BLOCKS_INDENT'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_BLOCKS_INDENT'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
...
$arTemplateParameters['ROUNDED'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_ROUNDED'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
$arTemplateParameters['SLIDER_NAV_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_NAV_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['SLIDER_NAV_SHOW'] === 'Y') {
    $arTemplateParameters['SLIDER_NAV_VIEW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_NAV_VIEW'),
        'TYPE' => 'LIST',
        'VALUES' => [
            1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_1')
        ],
...
$arTemplateParameters['SLIDER_DOTS_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_DOTS_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['SLIDER_DOTS_SHOW'] === 'Y') {
    $arTemplateParameters['SLIDER_DOTS_VIEW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_DOTS_VIEW'),
        'TYPE' => 'LIST',
        'VALUES' => [
            1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_1'),
            2 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_VIEW_2')
...
$arTemplateParameters['SLIDER_LOOP'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_LOOP'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
$arTemplateParameters['SLIDER_AUTO_USE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_AUTO_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['SLIDER_AUTO_USE'] === 'Y') {
    $arTemplateParameters['SLIDER_AUTO_TIME'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_AUTO_TIME'),
        'TYPE' => 'STRING',
        'DEFAULT' => '10000'
    ];
    $arTemplateParameters['SLIDER_AUTO_HOVER'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_SLIDER_AUTO_HOVER'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}