...
$arTemplateParameters['EFFECT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_EFFECT'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'none' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_EFFECT_NONE'),
        'blur' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_EFFECT_BLUR'),
        'brightness' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_EFFECT_BRIGHTNESS'),
        'grayscale' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_EFFECT_GRAYSCALE'),
        'sepia' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_EFFECT_SEPIA'),
...
if ($arCurrentValues['SLIDER_USE'] === 'Y') {
    ...
    if ($arCurrentValues['SLIDER_AUTO_USE'] === 'Y') {
       ...
       $arTemplateParameters['BACKGROUND_USE'] = [
          'PARENT' => 'VISUAL',
          'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_BACKGROUND_USE'),
          'TYPE' => 'CHECKBOX',
          'DEFAULT' => 'N',
          'REFRESH' => 'Y'
       ];
       ...
       if ($arCurrentValues['BACKGROUND_USE'] === 'Y') {
          $arTemplateParameters['BACKGROUND_THEME'] = [
             'PARENT' => 'VISUAL',
             'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_BACKGROUND_THEME'),
             'TYPE' => 'LIST',
             'VALUES' => [
                'light' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_BACKGROUND_THEME_LIGHT'),
                'dark' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_BACKGROUND_THEME_DARK')
             ],
             'DEFAULT' => 'light'
          ];
       }
...
$arTemplateParameters['FOOTER_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_FOOTER_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['FOOTER_SHOW'] === 'Y') {
    $arTemplateParameters['FOOTER_POSITION'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_FOOTER_POSITION'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'left' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_POSITION_LEFT'),
            'center' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_POSITION_CENTER'),
            'right' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_POSITION_RIGHT')
        ],
        'DEFAULT' => 'center'
    ];
    ...
    $arTemplateParameters['FOOTER_BUTTON_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_FOOTER_BUTTON_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['FOOTER_BUTTON_SHOW'] === 'Y') {
        $arTemplateParameters['FOOTER_BUTTON_TEXT'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_FOOTER_BUTTON_TEXT'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('C_MAIN_BRANDS_TEMPLATE_3_FOOTER_BUTTON_TEXT_DEFAULT')
        ];
    }
}