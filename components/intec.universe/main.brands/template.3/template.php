                        ...
                        <?= Html::beginTag('div', [
                            'class' => Html::cssClassFromArray([
                                ...
                                'intec-grid-item' => [
                                    ...
                                    '1000-4' => !$arVisual['SLIDER']['USE'] && $arVisual['COLUMNS'] >= 5,
                                    '800-3' => !$arVisual['SLIDER']['USE'] && $arVisual['COLUMNS'] >= 4,
                                    '500-2' => !$arVisual['SLIDER']['USE'] && $arVisual['COLUMNS'] >= 3,
                                    '350-1' => !$arVisual['SLIDER']['USE']
                                ]
                            ], true)
                        ]) ?>
                            <?= Html::beginTag($sTag, [
