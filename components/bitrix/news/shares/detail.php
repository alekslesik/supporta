...
if ($arParams['USE_BASKET'] == 'settings') {
    ...
    $arParams['DELAY_USE'] = Properties::get('basket-delay-use') ? 'Y' : 'N';

    $arParams['USE_COMPARE'] = Properties::get('basket-compare-use') ? 'Y' : 'N';
    ...
    if (Properties::get('basket-use')) {
        ...
        $arParams['DELAY_USE'] = 'N';
        $arParams['ACTION'] = 'detail';
    }
}
