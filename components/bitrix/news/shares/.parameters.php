...
if (Loader::includeModule('form')) {
    require(__DIR__.'/parameters/base/form.php');
} else if (Loader::includeModule('intec.startshop')) {
    require(__DIR__.'/parameters/lite/form.php');
}

if (Loader::includeModule('catalog')) {
    require_once('parameters/base/catalog.php');
} else if (Loader::includeModule('intec.startshop')) {
    require_once('parameters/lite/catalog.php');
}
...
if ($arCurrentValues['USE_BASKET'] !== 'settings') {
    $arTemplateParameters['DELAY_USE'] = array(
        'PARENT' => 'ADDITIONAL_SETTINGS',
        'NAME' => GetMessage('C_SHARES_USE_DELAY'),
        'TYPE' => 'CHECKBOX',
        'VALUE' => 'Y',
        'DEFAULT' => 'N'
    );
    $arTemplateParameters['USE_COMPARE'] = array(
        'PARENT' => 'ADDITIONAL_SETTINGS',
        'NAME' => GetMessage('C_SHARES_USE_COMPARE'),
        'TYPE' => 'CHECKBOX',
        'VALUE' => 'Y',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ...
    if ($arCurrentValues['USE_COMPARE'] === 'Y') {
        $arTemplateParameters['COMPARE_NAME'] = array(
            'PARENT' => 'ADDITIONAL_SETTINGS',
            'NAME' => GetMessage('C_SHARES_COMPARE_NAME'),
            'TYPE' => 'STRING',
            'DEFAULT' => 'compare'
        );
    }
