                ...
                <div class="catalog-element-price-range-item">
                    <div class="catalog-element-price-range-item-text">
                        ...
                        if (!empty($arPrice['QUANTITY_FROM'])) {
                            echo Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_PRICE_RANGE_FROM').' ';
                            echo $arPrice['QUANTITY_FROM'];

                            if (!empty($arPrice['QUANTITY_TO'])) {
                                echo ' ';
                            } else {
                                echo ' '.Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_PRICE_RANGE_MORE');
                            }
                        }

                        if (!empty($arPrice['QUANTITY_TO'])) {
                            echo Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_PRICE_RANGE_TO').' ';
