...
if (!empty($arCurrentValues['SERVICES_IBLOCK_ID'])) {
    $arProperties = null;
    $rsProperties = CIBlockProperty::GetList([], ["ACTIVE"=>"Y", "IBLOCK_ID"=>$arCurrentValues['SERVICES_IBLOCK_ID']]);
    while ($arProperty = $rsProperties->GetNext())
    {
    ...
    $arTemplateParameters['SERVICES_PROPERTY_PRICE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_SERVICES_PROPERTY_PRICE'),
        'TYPE' => 'LIST',
        'VALUES' => $arProperties,
        'ADDITIONAL_VALUES' => 'Y'
    ];
...
if (!empty($arIBlock)) {
    ...
    $arTemplateParameters['PROPERTY_ASSOCIATED'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_PROPERTY_ASSOCIATED'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesElement,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    if (!empty($arCurrentValues['PROPERTY_ASSOCIATED'])) {
        $arTemplateParameters['ASSOCIATED_SHOW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_ASSOCIATED_SHOW'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N'
        ];
    }
    ...
    $arTemplateParameters['PROPERTY_RECOMMENDED'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_PROPERTY_RECOMMENDED'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesElement,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    if (!empty($arCurrentValues['PROPERTY_RECOMMENDED'])) {
        $arTemplateParameters['RECOMMENDED_SHOW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_1_RECOMMENDED_SHOW'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N'
        ];
    }
