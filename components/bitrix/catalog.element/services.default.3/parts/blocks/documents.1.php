...
?>
<div class="catalog-element-documents">
    <div class="intec-content intec-content-visible">
        <div class="intec-content-wrapper">
            <?php if (!empty($arBlock['HEADER']['VALUE'])) { ?>
                <div class="catalog-element-documents-header" style="text-align:<?= $arBlock['HEADER']['POSITION'] ?>">
                    <?= $arBlock['HEADER']['VALUE'] ?>
                </div>
            <?php } ?>
            <?= Html::beginTag('div', [
                'class' => [
                    'catalog-element-documents-content',
                    'intec-grid' => [
                        '',
                        'wrap',
                        'i-5',
