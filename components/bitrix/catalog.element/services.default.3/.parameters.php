...
if (!empty($arIBlock)) {
    ...
    if ($arBlocks['banner']['ACTIVE']) {
        ...
        if (!empty($arCurrentValues['BLOCKS_BANNER_PROPERTY_ORDER_BUTTON_SHOW'])) {
            ...
            $arTemplateParameters['BLOCKS_BANNER_ORDER_FORM_SERVICE'] = array(
                'PARENT' => 'BASE',
                'TYPE' => 'LIST',
    ...
    if ($arBlocks['description.1']['ACTIVE']) {
        $arTemplateParameters['BLOCKS_DESCRIPTION_1_HEADER'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_BLOCKS_DESCRIPTION_1_HEADER'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_BLOCKS_DESCRIPTION_1_HEADER_DEFAULT')
        ];

        $arTemplateParameters['BLOCKS_DESCRIPTION_1_PROPERTY_HEADER'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_BLOCKS_DESCRIPTION_1_PROPERTY_HEADER'),
            'TYPE' => 'LIST',
            'VALUES' => $arProperties->asArray($hPropertiesString),
            'ADDITIONAL_VALUES' => 'Y'
        ];
