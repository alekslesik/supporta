...
<?= Html::beginTag('div', [
    ...
    <div class="catalog-element-content intec-content intec-content-visible">
        <div class="intec-content-wrapper">
            <div class="intec-grid intec-grid-wrap">
                ...
                <?= Html::beginTag('div', [
                    ...
                    <div class="catalog-element-block-right">
                        ...
                        <?php if (($arVisual['PROPERTIES']['SHOW'] && !empty($arResult['DISPLAY_PROPERTIES'])) || ($arResult["PROPERTIES"]['HARAKTER']['VALUE'])) { ?>
                            <?= Html::beginTag('div', [
                                'class' => [
                                ...
                                <?= Html::beginTag('div', [
                                    ...
                                    <div class="catalog-element-section-content-wrapper">
										<?
										if (!empty($arResult["PROPERTIES"]['HARAKTER']['VALUE']))
										{
											echo htmlspecialchars_decode($arResult["PROPERTIES"]['HARAKTER']['VALUE']['TEXT']);
										}
                            ...
                            <?= Html::beginTag('div', [
                                ...
                                <?= Html::beginTag('div', [
                                    ...
                                    <div class="catalog-element-section-content-wrapper">
										...
										{
											echo htmlspecialchars_decode($arResult["PROPERTIES"]['SOSTAV']['VALUE']['TEXT']);
										}
						...
						<?php if ($arResult["PROPERTIES"]['PRIMENEN']['VALUE']) { ?>
                            <?= Html::beginTag('div', [
                                'class' => [
                                    'catalog-element-properties',
                                    'catalog-element-section'
                                ...
                                <?= Html::beginTag('div', [
                                    ...
                                    <div class="catalog-element-section-content-wrapper">
										<?
										if (!empty($arResult["PROPERTIES"]['PRIMENEN']['VALUE']))
										{
											echo htmlspecialchars_decode($arResult["PROPERTIES"]['PRIMENEN']['VALUE']['TEXT']);
										}
                            ...
                            <?= Html::beginTag('div', [
                                ...
                                <?= Html::beginTag('div', [
                                    ...
                                    <div class="catalog-element-section-content-wrapper">
										...
										?>
										<?//=echo htmlspecialchars_decode($arResult["DESCRIPTION"]);?>
                                        <?= htmlspecialchars_decode(strip_tags($arResult[strtoupper($arVisual['DESCRIPTION']['MODE'].'_TEXT')], '<br>')) ?>
                                    </div>
                                <?= Html::endTag('div') ?>
                            <?= Html::endTag('div') ?>
                        <?php } ?>
            ...
            <?php } ?>
			<?
			//var_dump($arVisual['RECOMMENDED']['SHOW']);
			$gifts_arr_sect = array(146, 147, 148);
			if (in_array($arResult["IBLOCK_SECTION_ID"], $gifts_arr_sect)) {
				$arVisual['RECOMMENDED']['SHOW'] = true;
			}
			?>
