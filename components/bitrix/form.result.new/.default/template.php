        ...
        <?= $arResult['FORM_HEADER'] ?>
            ...
            <div class="form-result-new-buttons">
                <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                    ...
                    <div class="intec-grid-item-auto">
                        <input class="intec-ui intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-1" type="reset" value="<?= Loc::getMessage('C_FORM_RESULT_NEW_DEFAULT_BUTTONS_RESET') ?>" />
                    </div>
                </div>
            </div>
