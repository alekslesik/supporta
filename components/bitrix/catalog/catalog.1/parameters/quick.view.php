...
$arTemplateParameters[$sPrefix.'USE'] = [
    ...
    'NAME' => Loc::getMessage('C_CATALOG_CATALOG_1_QUICK_VIEW_USE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
];
...
if ($arCurrentValues[$sPrefix.'USE'] === 'Y') {
    ...
    $arTemplateParameters[$sPrefix.'TEMPLATE'] = [
        'PARENT' => 'LIST_SETTINGS',
        'NAME' => Loc::getMessage('C_CATALOG_CATALOG_1_QUICK_VIEW_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTemplates,
        'REFRESH' => 'Y'
    ];
    ...
    if (!empty($arCurrentValues['IBLOCK_ID'])) {
        ...
        $arTemplateParameters[$sPrefix . 'PROPERTY_CODE'] = [
            'PARENT' => 'LIST_SETTINGS',
            'NAME' => Loc::getMessage('C_CATALOG_CATALOG_1_QUICK_VIEW_PROPERTY_CODE'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'ADDITIONAL_VALUES' => 'Y',
    ...
    if (!empty($sTemplate)) {
        $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
            ...
            function ($sKey, &$arParameter) use (&$arParametersCommon) {
                ...
                $arParameter['NAME'] = Loc::getMessage('C_CATALOG_CATALOG_1_QUICK_VIEW').'. '.$arParameter['NAME'];
