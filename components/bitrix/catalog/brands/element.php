...
$sBackUrl = $arResult['FOLDER'];

if (empty($sBackUrl)) {
    $sBackUrl = $arResult['URL_TEMPLATES']['section'];
    $sBackUrl = StringHelper::replaceMacros($sBackUrl, [
        $arResult['ALIASES']['SECTION_ID'] => ''
    ]);
    $sBackUrl = new Url($sBackUrl);
    $sBackUrl->getQuery()->removeAt($arResult['ALIASES']['SECTION_ID']);
    $sBackUrl = $sBackUrl->build();
}
	...
	<div class="intec-content-wrapper">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                'CATALOG_DISPLAY' => $arParams['CATALOG_DISPLAY'],
                'CATALOG_IBLOCK_TYPE' => $arParams['CATALOG_IBLOCK_TYPE'],
                'CATALOG_IBLOCK_ID' => $arParams['CATALOG_IBLOCK_ID'],
                'CATALOG_IBLOCK_PROPERTY' => $arParams['CATALOG_IBLOCK_PROPERTY'],
                ...
                'DISPLAY_COMPARE' => 'Y',//$arParams['USE_COMPARE'],
