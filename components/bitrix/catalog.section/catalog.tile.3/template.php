...
include(__DIR__.'/parts/quick.view.php');
            ...
            <?= Html::beginTag('div', [
                ...
                'class' => Html::cssClassFromArray([
                    ...
                    'intec-grid-item' => [
                        ...
                        '550-1' => $arVisual['COLUMNS'] >= 2,
                        '850-2' => $arVisual['WIDE'] && $arVisual['COLUMNS'] >= 3,
                        '1200-3' => $arVisual['WIDE'] && $arVisual['COLUMNS'] >= 4,
                        '720-2' => !$arVisual['WIDE'] && $arVisual['COLUMNS'] >= 2,
                        '900-1' => !$arVisual['WIDE'] && $arVisual['COLUMNS'] >= 2,
