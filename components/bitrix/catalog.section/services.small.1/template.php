        ...
        <div class="catalog-section-wrapper-2 intec-content-wrapper">
            <?= Html::beginTag('div', [
                ...
                <?php
                    ...
                    if(!empty($arItem['DATA']['PRICE']) && !empty($arItem['DATA']['CURRENCY'])) {
                        $sPrice = number_format($arItem['DATA']['PRICE'], 0, '', ' ');
                        $sPrice = StringHelper::replaceMacros($arItem['DATA']['PRICE_FORMAT'], ['VALUE' => $sPrice,'CURRENCY' => $arItem['DATA']['CURRENCY']]);
                    }
