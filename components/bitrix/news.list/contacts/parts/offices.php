...
<div class="contacts-offices">
    <?php if ($arResult['TITLE']) { ?>
        <div class="contacts-title"><?= $arResult['TITLE'] ?></div>
    <?php } ?>
                                            ...
                                            <div class="contacts-information-section contacts-address">
                                                ...
                                                <div class="contacts-information-content">
                                                    <?= Html::tag(
                                                        ...
                                                        [
                                                            'class' => $sClass == 'a' ? 'intec-cl-text-hover' : null,
                                                            'href' => $sLink
                                                        ]
                                                    );?>
                                                </div>
                                                ...
                                                <div class="contacts-information-content">
                                                    <?php if (!empty($arItem['SYSTEM_PROPERTIES']['PHONE']['VALUE'])) { ?>
                                                        <div class="contacts-phone">
                                                            <?= GetMessage('N_L_CONTACTS_LIST_OFFICES_PHONE') ?>: <a href="tel:<?= $arItem['SYSTEM_PROPERTIES']['PHONE']['VALUE_CLEAN'] ?>"><?= $arItem['SYSTEM_PROPERTIES']['PHONE']['VALUE'] ?></a>
                                                        </div>
                                                    <?php } ?>
