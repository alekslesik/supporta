...
if (!empty($iIBlockId)) {
    ...
    $arTemplateParameters['PROPERTY_STORE_ID'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('N_L_CONTACTS_PARAMETERS_PROPERTY_STORE_ID'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['PROPERTY_OPENING_HOURS'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('N_L_CONTACTS_PARAMETERS_PROPERTY_OPENING_HOURS'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesString,
        'ADDITIONAL_VALUES' => 'Y'
    );
