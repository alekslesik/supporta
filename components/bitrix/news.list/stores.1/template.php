                ...
                <?php foreach($arResult['ITEMS'] as $arItem) { ?>
                    <div class="news-list-item intec-grid intec-grid-wrap intec-grid-a-v-center">
                        <div class="news-list-image-wrap intec-grid-item-auto intec-grid-item-450-1">
                            <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="news-list-image" style="background-image: url('<?= !empty($arItem['PREVIEW_PICTURE']['SRC']) ? $arItem['PREVIEW_PICTURE']['SRC'] : $templateFolder.'/images/picture.missing.jpg' ?>')"></a>
                        </div>
