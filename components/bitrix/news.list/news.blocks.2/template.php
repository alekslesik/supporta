                    ...
                    <?php foreach ($arResult['ITEMS'] as $arItem) { ?>
                        ...
                        <div class="news-list-item<?= $bFirst ? ' news-list-item-first' : null?>">
                            <div class="news-list-item-wrapper" id="<?= $sAreaId ?>">
                                <?php if ($bFirst) { ?>
                                    <a class="news-list-item-wrapper-2 intec-image-effect" href="<?= $arItem['DETAIL_PAGE_URL'] ?>" style="background-image: url('<?= $sImage?>')">
                                ...
                                <?php } else { ?>
                                    <?php if ($arParams['DISPLAY_PICTURE'] == 'Y') { ?>
                                        <div class="news-list-image">
                                            <a class="news-list-image-wrapper intec-image-effect" href="<?= $arItem['DETAIL_PAGE_URL'] ?>" style="background-image: url('<?= $sImage ?>')"></a>
                                        </div>
                                    <?php } ?>
