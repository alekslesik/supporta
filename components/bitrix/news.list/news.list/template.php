                    ...
                    <div class="news-list-item">
                        <div class="news-list-item-wrapper" id="<?= $sAreaId ?>">
                            <?php if ($arParams['DISPLAY_PICTURE'] == 'Y') { ?>
                                <a class="news-list-image intec-image-effect" href="<?= $arItem['DETAIL_PAGE_URL'] ?>" style="background-image: url('<?= $sImage ?>')"></a>
                            <?php } ?>
                            <div class="news-list-information<?= $arParams['DISPLAY_PICTURE'] == 'Y' ? ' news-list-information-with-image' : null ?>">
