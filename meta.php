    ...
    'properties' => [
        ...
        'services-element-template' => [
            ...
            'values' => [[
                ...
                'name' => Loc::getMessage('template.meta.properties.services-element-template.narrow.3'),
                'value' => 'narrow.3'
            ], [
                'name' => Loc::getMessage('template.meta.properties.services-element-template.narrow.4'),
                'value' => 'narrow.4'
            ]]
        ]
    ]
...
unset($meta['properties']['pages-main-template']);
unset($meta['properties']['pages-main-blocks']['blocks']['icons']);
unset($meta['properties']['pages-main-blocks']['blocks']['gallery']);
unset($meta['properties']['pages-main-blocks']['blocks']['services']);
unset($meta['properties']['pages-main-blocks']['blocks']['video']);
unset($meta['properties']['pages-main-blocks']['blocks']['faq']);
unset($meta['properties']['pages-main-blocks']['blocks']['stages']);
unset($meta['properties']['pages-main-blocks']['blocks']['certificates']);
unset($meta['properties']['pages-main-blocks']['blocks']['shares']);
unset($meta['properties']['pages-main-blocks']['blocks']['articles']);
unset($meta['properties']['pages-main-blocks']['blocks']['rates']);
unset($meta['properties']['pages-main-blocks']['blocks']['contacts']);
unset($meta['properties']['services-root-menu-show']);
unset($meta['properties']['services-root-template']);
unset($meta['properties']['services-section-menu-show']);
unset($meta['properties']['services-section-template']);
unset($meta['properties']['services-element-template']);
unset($meta['properties']['sections-shares-template']);
unset($meta['properties']['sections-contacts-template']);
unset($meta['properties']['sections-news-template']);
unset($meta['properties']['sections-certificates-template']);
